...
internal class Day08Task1Tests
{
    [Test]
    public void count_26_digits_1478()
    {
...
gcafb gcf dcaebfg ecagb gf abcdeg gaef cafbge fdbac fegbdc | fgae cfgab fg bagce".Split(Environment.NewLine);
        ...
        var result = solver.Count1478(parsedInput);
    ...
    [Test]
    public void counts_449_digits_1478()
    {
